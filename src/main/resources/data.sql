...
insert into question (created_by, updated_at, updated_by, heading, text, tag, up_vote) values (1, null, 1, 'is wicket nice ?', 'Wicket is nice', 'java,wicket', 1);
...
insert into question (created_by, updated_at, updated_by, heading, text, tag, up_vote) values (1, null, 1, 'is spring nice ?', 'Spring is nice & the best framework to work on as it is modular and easy to understand bla bla bla', 'java,spring,html', 3);
...
insert into question (created_by, updated_at, updated_by, heading, text, tag, up_vote) values ( 1, null, 1, 'is hibernate nice ?', 'Hibernate is nice', 'java,hibernate,sql', 1);
